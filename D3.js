...
console.log("Tutti i nomi dei personaggi", charactersNames);
/* ESERCIZIO 3
...
*/
for (let i = 0; i < starWarsCharacters.length; i++) {
  const occhiPersonaggio = starWarsCharacters[i];
  switch (occhiPersonaggio.eye_color) {
    case "blue":
      eyeColor.blue.push(occhiPersonaggio);
      break;
    case "yellow":
      eyeColor.yellow.push(occhiPersonaggio);
      break;
    case "brown":
      eyeColor.brown.push(occhiPersonaggio);
      break;
    case "red":
      eyeColor.red.push(occhiPersonaggio);
      break;
    case "blue-gray":
      eyeColor["blue-gray"].push(occhiPersonaggio);
      break;
  }
}
console.log("Smistamento Colore Occhi", eyeColor);
/* ESERCIZIO 6
...
crewMass = 1200;
console.log("Peso attuale della Crew", crewMass);
